...
public enum Servers {
    ...
    MY_CALLBACK_ENDPOINT; //TODO: Write general description for this element
    ...
    static {
        ...
        MY_CALLBACK_ENDPOINT.value = "MY_CALLBACK_ENDPOINT";

        valueMap.put("default", ENUM_DEFAULT);
        valueMap.put("MY_CALLBACK_ENDPOINT", MY_CALLBACK_ENDPOINT);
    }
